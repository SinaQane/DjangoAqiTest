...
def home(request):
    ...
    api_req = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=19946&distance=25&API_KEY=1B1D61B5-1FC1-4A1D-A851-B4701F2EBC39")
